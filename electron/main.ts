...
import { startGlobalPoller, stopGlobalPoller, registerStopKeys, setStatusUpdateCallback, stopMacro, setAppFocused } from './macro-engine';
...
function createWindow() {
  mainWindow = new BrowserWindow({
    ...
    icon: path.join(__dirname, process.env.NODE_ENV === 'development' ? '../../public/icon.ico' : '../../dist/icon.ico'),
  });
